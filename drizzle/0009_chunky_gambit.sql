...
--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "selected_ai_provider" text DEFAULT 'gemini-flash';--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "ai_provider_custom_name" text;--> statement-breakpoint
