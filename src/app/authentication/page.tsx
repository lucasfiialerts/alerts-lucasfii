...
import { ArrowLeftIcon, CheckCircleIcon, TrendingUpIcon, BellIcon, CalendarIcon, DollarSignIcon, ListCheckIcon, Loader2 } from "lucide-react";
          ...
          <div className="w-full">
            ...
            <div className="bg-slate-900/90 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-8 shadow-2xl">
              ...
              <div className="space-y-4 mb-8">
                ...
                <Button
                  variant="outline"
                  className="w-full h-14 border-2 border-slate-600 bg-white hover:bg-gray-50 text-slate-900 font-semibold transition-all duration-200 cursor-pointer text-base rounded-xl hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
