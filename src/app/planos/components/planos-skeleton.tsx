export function PlanosSkeleton() {
  ...
  <div className="hidden lg:block w-64 bg-[#1a1a35] border-r border-gray-800">
        ...
        <div className="flex-1">
          ...
          {/* Planos Content Skeleton */}
          <main className="p-4 md:p-6 space-y-6 pb-20 md:pb-6 bg-[#0f0f23] min-h-screen">
          {/* Hero Section Skeleton */}
          <div className="text-center mb-8">
            <div className="w-24 h-6 bg-gray-700 rounded animate-pulse mx-auto mb-2"></div>
            <div className="w-80 h-12 bg-gray-700 rounded animate-pulse mx-auto mb-4"></div>
            <div className="w-24 h-1 bg-gray-700 rounded animate-pulse mx-auto mb-6"></div>
            <div className="w-96 h-5 bg-gray-700 rounded animate-pulse mx-auto mb-2"></div>
            <div className="w-80 h-5 bg-gray-700 rounded animate-pulse mx-auto"></div>
          </div>

          {/* Subscription Status Skeleton */}
          <div className="bg-[#1a1a35] border border-gray-800 rounded-lg p-4">
          ...
          {/* Plans Section Title Skeleton */}
          <div className="w-64 h-8 bg-gray-700 rounded animate-pulse mx-auto mb-8"></div>
          <div className="w-80 h-5 bg-gray-700 rounded animate-pulse mx-auto mb-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8 mb-16">
            {[1, 2, 3].map((plan) => (
              <div
                key={plan}
                className="bg-[#1a1a35] border border-gray-800 rounded-lg p-6 relative"
              >
                {/* Popular Badge Skeleton */}
                {plan === 2 && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <div className="w-32 h-6 bg-gray-700 rounded-full animate-pulse"></div>
                  </div>
                )}
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center">
                    <div className="w-24 h-6 bg-gray-700 rounded animate-pulse mx-auto mb-4"></div>
                  ...
                  <div className="space-y-3">
                    {[1, 2, 3, 4, 5].map((feature) => (
                      <div key={feature} className="flex items-center space-x-3">
                        <div className="w-5 h-5 bg-gray-700 rounded-full animate-pulse flex-shrink-0"></div>
          ...
          <div className="space-y-6">
            <div className="text-center">
              <div className="w-64 h-8 bg-gray-700 rounded animate-pulse mx-auto mb-2"></div>
              <div className="w-80 h-5 bg-gray-700 rounded animate-pulse mx-auto"></div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
              {[1, 2, 3, 4].map((faq) => (
                <div key={faq} className="bg-[#1a1a35] border border-gray-800 rounded-lg p-6">
                  <div className="space-y-4">
