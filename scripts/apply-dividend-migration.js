...
/**
 * Aplicar migração das tabelas de dividendos
 */
...
async function applyMigration() {
  ...
  try {
    ...
    console.log('✅ Tabelas de dividendos criadas com sucesso!');
    console.log('📊 Tabelas criadas:');
    console.log('   - fii_dividend (histórico de dividendos)');
    console.log('   - dividend_alert_log (log de alertas enviados)');
